    ...
    <div className="container travel-booking">
      <div className="mt-4" data-aos="fade-down">
        <div className="text-center">
          <h2>
            <span className="text-danger">Infinity</span> Tour
          </h2>
          <h4 className="ms-5">
            A Destination For The{" "}
            <span className="text-danger"> New Millennium</span>.
          </h4>
        </div>
      </div>
        ...
        <Row className="m-2">
          <Col sm={12} md={5} lg={5} data-aos="fade-right">
            <div className="mt-4 booking-info">
              ...
              <Button onClick={handleBooking} variant="outline-dark">
                Book Now
              </Button>
            </div>
          </Col>
          <Col className="mt-4" sm={12} md={6} lg={6} data-aos="fade-left">
            <div className="ms-4">
